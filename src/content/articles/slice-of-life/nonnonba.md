...
mangaTitle: "NonNonBa"
mangaTitleJa: "のんのんばあとオレ"
mangaAuthor: "Shigeru Mizuki"
serialization: "Weekly Modern"
publisher: "Kodansha"
volumes: 1
status: "Completed"
englishVolumes: 1
...
NonNonBa is one of the kindest manga I've read. Mizuki is gentle with his younger self — a poor, dreamy kid who didn't fit in. NonNonBa is his anchor. The yokai aren't really scary; they're explanations for the way the world feels when you're young. Reading it, you understand where Gegege no Kitaro came from.
...
*NonNonBa* has been fully published in English. All 1 volumes are available.
...
Find *NonNonBa* on Amazon:

👉 [Search for NonNonBa on Amazon](https://www.amazon.com/s?k=NonNonBa&tag=dearmanga-20)
