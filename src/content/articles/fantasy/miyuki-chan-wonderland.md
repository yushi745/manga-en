...
**Age Rating**: M (Mature)
**Content Warnings**: fanservice, lgbtq-content, sexual-themes
...
Miyuki-chan is what happens when CLAMP decides to just have fun. The art is gorgeous, the gags are silly, and the whole thing knows exactly what it is. There's no deep meaning — it's a sketchbook of fantasies in manga form. As an experiment in genre, it's surprisingly committed.
...
If you enjoyed *Miyuki-chan in Wonderland*, try:
...
*Miyuki-chan in Wonderland* has been fully published in English. All 1 volumes are available.
