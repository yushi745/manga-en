---
title: "Rock Lee's Springtime of Youth Review"
slug: "naruto-rock-lee"
genre: "Comedy / Action"
genreSlug: "action"
mangaTitle: "Rock Lee's Springtime of Youth Full Power Ninja Chronicles"
mangaTitleJa: "ロック・リーの青春フルパワー忍伝"
mangaAuthor: "Masashi Kishimoto / Kenji Taira"
...
**Age Rating**: T (Teen)
**Content Warnings**: slapstick comedy, mild action
...
- **[Naruto](/action/naruto)** — The main series — essential context
- **[Naruto: Chibi Sasuke's Sharingan Legend](/action/chibi-sasuke)** — Another Naruto comedic spin-off
- **[Dragon Ball SD](/action/dragon-ball-sd)** — Similar comedic retelling of a famous series
...
| Format | Link | Notes |
|--------|------|-------|
| Paperback | [Amazon](https://www.amazon.com/dp/1421558564?tag=dearmanga-20) | VIZ edition — all 8 volumes |
