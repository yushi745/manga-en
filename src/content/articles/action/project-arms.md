...
mangaTitleJa: "プロジェクト アームズ"
mangaAuthor: "Ryoji Minagawa / Kyoichi Nanatsuki"
...
**Age Rating**: M (Mature)
**Content Warnings**: graphic violence, body horror, sci-fi horror
...
- **[Biomega](/action/biomega)** — Sci-fi body horror with similar aesthetic
- **[Parasyte](/action/parasyte)** — Body horror with similar 'part of me is alien' premise
- **[Battle Angel Alita](/action/battle-angel-alita)** — Classic sci-fi action from the same era
...
**Status**: Complete
**Publisher**: VIZ Media
**Volumes Available in English**: 22 of 22
...
| Format | Link | Notes |
|--------|------|-------|
| Paperback | [Amazon](https://www.amazon.com/dp/1591168562?tag=dearmanga-20) | VIZ edition — all 22 volumes |
