...
ageRating: "M (Mature)"
contentWarnings: ["delinquent violence", "gang fights", "school-based gang culture", "mature themes"]
description: "Worst is the direct sequel to Crows — returning to Suzuran All-Boys High School one generation later, with new students, new factions, and new battles for supremacy in the school known as the place where crows gather."
publishedAt: "2026-04-25"
tags: ["action", "drama", "delinquent", "high-school", "fighting", "seinen", "sequel"]
rating: 4
hasAffiliate: false
---
...
**Age Rating**: M (Mature)
**Content Warnings**: Delinquent violence throughout — significant, and the point of the series. Gang dynamics and hierarchies. Mature content consistent with the predecessor.
