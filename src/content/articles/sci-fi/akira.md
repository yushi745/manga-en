---
title: "Akira Review: The Manga That Invented Modern Science Fiction"
slug: "akira"
genre: "Sci-Fi / Action"
genreSlug: "sci-fi"
mangaTitle: "Akira"
...
publisher: "Kodansha / Kodansha Comics USA"
volumes: 6
status: "Completed"
englishVolumes: 6
...
coverImage: "https://covers.openlibrary.org/b/isbn/1569714983-L.jpg"
...
**Age Rating**: M (Mature)
**Content Warnings**: Extreme violence and gore, war and urban destruction depicted extensively, body horror (transformation sequences), psychological horror, drug use as a plot element
...
1988. A mysterious explosion levels Tokyo, triggering World War III. Thirty-one years later, Neo-Tokyo rises from the ruins on reclaimed land — a gleaming, corrupt metropolis preparing to host the Olympics, plagued by gangs, political violence, and a government that fears what it doesn't control.
...
**Status**: Complete
**English Volumes**: 6 (all volumes available)
**Translator**: Kodansha Comics USA
**Translation Quality**: Excellent — Dark Horse's original translation remains highly regarded
...
- [📚 Akira Vol. 1 — Paperback](https://www.amazon.com/dp/1935429000)
